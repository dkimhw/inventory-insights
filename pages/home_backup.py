...
# make_aggregated_data = d.get_make_table_data(start_date, end_date)
# make_aggregated_data_table = go.Figure(
#   data=[go.Table(
#   header=dict(
...
#   ),
#   cells= dict(
#     values = [make_aggregated_data.columns, make_aggregated_data.make, make_aggregated_data.total_inventory
#     , make_aggregated_data.avg_vehicle_year, make_aggregated_data.avg_price, make_aggregated_data.avg_mileage
#     , make_aggregated_data.most_popular_exterior_color],
#     line_color='darkslategray',
#     fill_color = [[rowOddColor,rowEvenColor,rowOddColor, rowEvenColor,rowOddColor]*make_aggregated_data.shape[0]],
#     align = ['left', 'center'],
